...
if __name__=="__main__":
    ...
    best_model_dir = f'./models_next/exp{args.logs}'
    if not os.path.isdir(best_model_dir):
        os.makedirs(best_model_dir)

    logs_dir = f"./logs_next/exp{args.logs}"
    ...
    # next bert
    # python train.py --logs=0 --gpu=7
    # nohup python train.py --logs=0 --gpu=7 --bert_type=next > xexp0.out &
    
    # action
    # python train.py --logs=1 --gpu=6
    # nohup python train.py --logs=1 --gpu=6 --bert_type=action > xexp1.out &
    
    # caption
    # python train.py --logs=2 --gpu=3
    # nohup python train.py --logs=2 --gpu=3 --bert_type=caption > xexp2.out &

    # actionm caption
    # python train.py --logs=3 --gpu=2
    # nohup python train.py --logs=3 --gpu=2 --bert_type=action_caption > xexp3.out &