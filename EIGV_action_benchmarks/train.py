...
if __name__=="__main__":
    ...
    # next bert
    # python train.py --logs=0 --gpu=7 --bert_type=next
    # nohup python train.py --logs=0 --gpu=7 --bert_type=next > exp0.out &
    
    # action
    # python train.py --logs=1 --gpu=6 --bert_type=action
    # nohup python train.py --logs=1 --gpu=6 --bert_type=action > exp1.out &
    
    # caption
    # python train.py --logs=2 --gpu=3 --bert_type=caption
    # nohup python train.py --logs=2 --gpu=3 --bert_type=caption > exp2.out &

    # actionm caption
    # python train.py --logs=3 --gpu=2 --bert_type=action_caption
    # nohup python train.py --logs=3 --gpu=2 --bert_type=action_caption > exp3.out &