...
class VideoQADataset(Dataset):
    ...
    def __init__(self, sample_list_path,video_feature_path, mode):
        ...
        print(f'writing the vid2idx mapping')
        with open(f'./temp_vid2idx_mapping_{mode}.txt', 'w') as temp_f:
            for key, val in self.vid2idx.items():
                temp_f.write(f'{val}: {key},\n')
...
if __name__ == "__main__":
    ...
    video_feature_path = '/home/ec2-user/next-qa'
    sample_list_path = '/home/ec2-user/next-qa'
