...
def get_args_parser():
    ...
    parser.add_argument(
        "--output-dir", default="video/", help="path where to save, empty for no saving"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--caption_example", default="arm wrestling. two people are holding hands", type=str, help="caption example for STVG demo"
    )
    parser.add_argument(
        "--video_example",
        default="demo.mp4",
